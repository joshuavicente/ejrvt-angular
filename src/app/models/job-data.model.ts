export const jobs = [
  {
    ...
    description: 'Develop scalable applications for clients using Angular and Adobe Experience Manager (AEM).',
    skills: ['Angular', 'SASS', 'TypeScript', 'SourceTree', 'Figma', 'Azure', 'AEM']
  },
  {
    date: '2022 — 2023',
